...
| `dark` | the site is dark; the frame reads light on it. `dark="auto"` follows the page's own `color-scheme` (set by a site's light/dark toggle), else the visitor's preference |
